...
public class ErrorValidation extends BaseTest {
		...
		public void LoginValidation() {
			...
			AssertJUnit.assertEquals("Invalid credentials, please try again, click Forgot Password? or email support@sportsgearswag.com for assistance.", 
...
//		driver.findElement(By.cssSelector("button[class='btn repeat-btn btn-block']")).click();
		...
		if(ErrorMessage.contains("Your account has been created successfully.")) {
			...
			System.out.println("We have already registered an account with this email. Please Sign In to your account or use another email to create new account.");
		}
		...
		public void UserForgotPassword() throws InterruptedException {
			...
			AssertJUnit.assertEquals("This is not a registered email address. Please try again or email support@sportsgearswag.com for assistance.",
