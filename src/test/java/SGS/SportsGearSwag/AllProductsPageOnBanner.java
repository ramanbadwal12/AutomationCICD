...
public class AllProductsPageOnBanner {
	 ...
	 public static void main(String[] args) throws InterruptedException {
			...
			driver.get("https://sportsgearswag.com/all-products");
			
			//Homepage header section
			
			  WebElement section = driver.findElement(By.cssSelector("#shop-products-list"));
