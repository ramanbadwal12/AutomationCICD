...
public class CategoryShopPageList {
	 ...
	 public static void main(String[] args) throws InterruptedException {
			...
			driver.get("https://dev1.sportsgearswag.com/basketball/shop");
...
//			Scroll the page
			...
			WebElement section = driver.findElement(By.cssSelector("#all-products-list"));
